...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num1 === max) return "Número 1 es mayor y positivo";
...
function tablaDelSeis() {
  ...
  //La función devuelve un array con los estadoados de la tabla de multiplicar del 6 en orden creciente.
  //Escribe tu código aquí
  let tablaDel6 = [];
